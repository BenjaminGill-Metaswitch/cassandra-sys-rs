...
extern "C" {
    ...
    pub fn cass_cluster_set_queue_size_event(cluster: *mut CassCluster, queue_size: ::std::os::raw::c_uint)
                                             -> CassError;
    pub fn cass_cluster_set_queue_size_log(cluster: *mut CassCluster, queue_size: ::std::os::raw::c_uint) -> CassError;
    ...
    pub fn cass_cluster_set_credentials_n(cluster: *mut CassCluster, username: *const ::std::os::raw::c_char,
        username_length: size_t, password: *const ::std::os::raw::c_char,
        password_length: size_t);
    pub fn cass_cluster_set_load_balance_round_robin(cluster: *mut CassCluster);
    pub fn cass_cluster_set_load_balance_dc_aware(cluster: *mut CassCluster, local_dc: *const ::std::os::raw::c_char,
    ...
    pub fn cass_cluster_set_load_balance_dc_aware_n(cluster: *mut CassCluster,
        local_dc: *const ::std::os::raw::c_char, local_dc_length: size_t,
        used_hosts_per_remote_dc: ::std::os::raw::c_uint,
        allow_remote_dcs_for_local_cl: cass_bool_t)
                                                    -> CassError;
    ...
    pub fn cass_session_connect_keyspace_n(session: *mut CassSession, cluster: *const CassCluster,
        keyspace: *const ::std::os::raw::c_char, keyspace_length: size_t)
                                           -> *mut CassFuture;
    ...
    pub fn cass_keyspace_meta_table_by_name_n(keyspace_meta: *const CassKeyspaceMeta,
        table: *const ::std::os::raw::c_char, table_length: size_t)
                                              -> *const CassTableMeta;
    ...
    pub fn cass_keyspace_meta_materialized_view_by_name_n(keyspace_meta: *const CassKeyspaceMeta,
        view: *const ::std::os::raw::c_char, view_length: size_t)
                                                          -> *const CassMaterializedViewMeta;
    ...
    pub fn cass_keyspace_meta_user_type_by_name_n(keyspace_meta: *const CassKeyspaceMeta,
        type_: *const ::std::os::raw::c_char, type_length: size_t)
                                                  -> *const CassDataType;
    ...
    pub fn cass_keyspace_meta_function_by_name_n(keyspace_meta: *const CassKeyspaceMeta,
        name: *const ::std::os::raw::c_char, name_length: size_t,
        arguments: *const ::std::os::raw::c_char, arguments_length: size_t)
                                                 -> *const CassFunctionMeta;
    ...
    pub fn cass_table_meta_index(table_meta: *const CassTableMeta, index: size_t) -> *const CassIndexMeta;
    ...
    pub fn cass_table_meta_materialized_view(table_meta: *const CassTableMeta, index: size_t)
                                             -> *const CassMaterializedViewMeta;
    ...
    pub fn cass_table_meta_clustering_key_order(table_meta: *const CassTableMeta, index: size_t)
                                                -> CassClusteringOrder;
    ...
    pub fn cass_materialized_view_meta_column_by_name_n(view_meta: *const CassMaterializedViewMeta,
        column: *const ::std::os::raw::c_char, column_length: size_t)
                                                        -> *const CassColumnMeta;
    pub fn cass_materialized_view_meta_name(view_meta: *const CassMaterializedViewMeta,
        name: *mut *const ::std::os::raw::c_char, name_length: *mut size_t);
    pub fn cass_materialized_view_meta_base_table(view_meta: *const CassMaterializedViewMeta) -> *const CassTableMeta;
    pub fn cass_materialized_view_meta_column_count(view_meta: *const CassMaterializedViewMeta) -> size_t;
    pub fn cass_materialized_view_meta_column(view_meta: *const CassMaterializedViewMeta, index: size_t)
                                              -> *const CassColumnMeta;
    pub fn cass_materialized_view_meta_partition_key_count(view_meta: *const CassMaterializedViewMeta) -> size_t;
    pub fn cass_materialized_view_meta_partition_key(view_meta: *const CassMaterializedViewMeta, index: size_t)
                                                     -> *const CassColumnMeta;
    pub fn cass_materialized_view_meta_clustering_key_count(view_meta: *const CassMaterializedViewMeta) -> size_t;
    pub fn cass_materialized_view_meta_clustering_key(view_meta: *const CassMaterializedViewMeta, index: size_t)
                                                      -> *const CassColumnMeta;
    pub fn cass_materialized_view_meta_clustering_key_order(view_meta: *const CassMaterializedViewMeta, index: size_t)
                                                            -> CassClusteringOrder;
    ...
    pub fn cass_function_meta_full_name(function_meta: *const CassFunctionMeta,
        full_name: *mut *const ::std::os::raw::c_char, full_name_length: *mut size_t);
    ...
    pub fn cass_function_meta_language(function_meta: *const CassFunctionMeta,
        language: *mut *const ::std::os::raw::c_char, language_length: *mut size_t);
    ...
    pub fn cass_ssl_add_trusted_cert_n(ssl: *mut CassSsl, cert: *const ::std::os::raw::c_char, cert_length: size_t)
                                       -> CassError;
    ...
    pub fn cass_ssl_set_cert_n(ssl: *mut CassSsl, cert: *const ::std::os::raw::c_char, cert_length: size_t)
                               -> CassError;
    pub fn cass_ssl_set_private_key(ssl: *mut CassSsl, key: *const ::std::os::raw::c_char,
        password: *const ::std::os::raw::c_char)
                                    -> CassError;
    pub fn cass_ssl_set_private_key_n(ssl: *mut CassSsl, key: *const ::std::os::raw::c_char, key_length: size_t,
        password: *const ::std::os::raw::c_char, password_length: size_t)
                                      -> CassError;
    pub fn cass_authenticator_address(auth: *const CassAuthenticator, address: *mut CassInet);
    pub fn cass_authenticator_hostname(auth: *const CassAuthenticator, length: *mut size_t)
                                       -> *const ::std::os::raw::c_char;
    pub fn cass_authenticator_class_name(auth: *const CassAuthenticator, length: *mut size_t)
                                         -> *const ::std::os::raw::c_char;
    ...
    pub fn cass_authenticator_response(auth: *mut CassAuthenticator, size: size_t) -> *mut ::std::os::raw::c_char;
    ...
    pub fn cass_future_custom_payload_item(future: *mut CassFuture, index: size_t,
        name: *mut *const ::std::os::raw::c_char, name_length: *mut size_t,
        value: *mut *const cass_byte_t, value_size: *mut size_t)
                                           -> CassError;
    pub fn cass_statement_new(query: *const ::std::os::raw::c_char, parameter_count: size_t) -> *mut CassStatement;
    pub fn cass_statement_new_n(query: *const ::std::os::raw::c_char, query_length: size_t, parameter_count: size_t)
                                -> *mut CassStatement;
    pub fn cass_statement_reset_parameters(statement: *mut CassStatement, count: size_t) -> CassError;
    ...
    pub fn cass_statement_bind_bool_by_name_n(statement: *mut CassStatement, name: *const ::std::os::raw::c_char,
        name_length: size_t, value: cass_bool_t)
                                              -> CassError;
    pub fn cass_statement_bind_string(statement: *mut CassStatement, index: size_t,
        value: *const ::std::os::raw::c_char)
                                      -> CassError;
    pub fn cass_statement_bind_string_n(statement: *mut CassStatement, index: size_t,
        value: *const ::std::os::raw::c_char, value_length: size_t)
                                        -> CassError;
    ...
    pub fn cass_statement_bind_string_by_name_n(statement: *mut CassStatement, name: *const ::std::os::raw::c_char,
        name_length: size_t, value: *const ::std::os::raw::c_char,
        value_length: size_t)
                                                -> CassError;
    ...
    pub fn cass_statement_bind_bytes_by_name_n(statement: *mut CassStatement, name: *const ::std::os::raw::c_char,
        name_length: size_t, value: *const cass_byte_t, value_size: size_t)
                                               -> CassError;
    pub fn cass_statement_bind_custom(statement: *mut CassStatement, index: size_t,
        class_name: *const ::std::os::raw::c_char, value: *const cass_byte_t,
        value_size: size_t)
                                      -> CassError;
    pub fn cass_statement_bind_custom_n(statement: *mut CassStatement, index: size_t,
        class_name: *const ::std::os::raw::c_char, class_name_length: size_t,
        value: *const cass_byte_t, value_size: size_t)
                                        -> CassError;
    ...
    pub fn cass_statement_bind_custom_by_name_n(statement: *mut CassStatement, name: *const ::std::os::raw::c_char,
        name_length: size_t, class_name: *const ::std::os::raw::c_char,
        class_name_length: size_t, value: *const cass_byte_t,
        value_size: size_t)
                                                -> CassError;
    ...
    pub fn cass_statement_bind_decimal_by_name_n(statement: *mut CassStatement, name: *const ::std::os::raw::c_char,
        name_length: size_t, varint: *const cass_byte_t,
        varint_size: size_t, scale: cass_int32_t)
                                                 -> CassError;
    pub fn cass_statement_bind_collection(statement: *mut CassStatement, index: size_t,
        collection: *const CassCollection)
                                          -> CassError;
    pub fn cass_statement_bind_collection_by_name(statement: *mut CassStatement, name: *const ::std::os::raw::c_char,
        collection: *const CassCollection)
                                                  -> CassError;
    pub fn cass_statement_bind_collection_by_name_n(statement: *mut CassStatement,
        ...
        collection: *const CassCollection)
                                                    -> CassError;
    pub fn cass_statement_bind_tuple(statement: *mut CassStatement, index: size_t, tuple: *const CassTuple)
                                     -> CassError;
    ...
    pub fn cass_prepared_parameter_name(prepared: *const CassPrepared, index: size_t,
        name: *mut *const ::std::os::raw::c_char, name_length: *mut size_t)
                                        -> CassError;
    ...
    pub fn cass_data_type_add_sub_value_type_by_name_n(data_type: *mut CassDataType,
        ...
        sub_value_type: CassValueType)
                                                       -> CassError;
    pub fn cass_collection_new(type_: CassCollectionType, item_count: size_t) -> *mut CassCollection;
    pub fn cass_collection_new_from_data_type(data_type: *const CassDataType, item_count: size_t)
                                              -> *mut CassCollection;
    ...
    pub fn cass_tuple_set_string(tuple: *mut CassTuple, index: size_t, value: *const ::std::os::raw::c_char)
                                 -> CassError;
    pub fn cass_tuple_set_string_n(tuple: *mut CassTuple, index: size_t, value: *const ::std::os::raw::c_char,
        value_length: size_t)
                                   -> CassError;
    pub fn cass_tuple_set_bytes(tuple: *mut CassTuple, index: size_t, value: *const cass_byte_t, value_size: size_t)
                                -> CassError;
    pub fn cass_tuple_set_custom(tuple: *mut CassTuple, index: size_t, class_name: *const ::std::os::raw::c_char,
        value: *const cass_byte_t, value_size: size_t)
                                 -> CassError;
    pub fn cass_tuple_set_custom_n(tuple: *mut CassTuple, index: size_t, class_name: *const ::std::os::raw::c_char,
        class_name_length: size_t, value: *const cass_byte_t, value_size: size_t)
                                   -> CassError;
    ...
    pub fn cass_user_type_set_bool_by_name_n(user_type: *mut CassUserType, name: *const ::std::os::raw::c_char,
        name_length: size_t, value: cass_bool_t)
                                             -> CassError;
    pub fn cass_user_type_set_string(user_type: *mut CassUserType, index: size_t,
        value: *const ::std::os::raw::c_char)
                                     -> CassError;
    pub fn cass_user_type_set_string_n(user_type: *mut CassUserType, index: size_t,
        value: *const ::std::os::raw::c_char, value_length: size_t)
                                       -> CassError;
    ...
    pub fn cass_user_type_set_bytes_by_name_n(user_type: *mut CassUserType, name: *const ::std::os::raw::c_char,
        name_length: size_t, value: *const cass_byte_t, value_size: size_t)
                                              -> CassError;
    pub fn cass_user_type_set_custom(user_type: *mut CassUserType, index: size_t,
        class_name: *const ::std::os::raw::c_char, value: *const cass_byte_t,
        value_size: size_t)
                                     -> CassError;
    pub fn cass_user_type_set_custom_n(user_type: *mut CassUserType, index: size_t,
        class_name: *const ::std::os::raw::c_char, class_name_length: size_t,
        value: *const cass_byte_t, value_size: size_t)
                                       -> CassError;
    ...
    pub fn cass_user_type_set_collection_by_name(user_type: *mut CassUserType, name: *const ::std::os::raw::c_char,
        value: *const CassCollection)
                                                 -> CassError;
    pub fn cass_user_type_set_collection_by_name_n(user_type: *mut CassUserType, name: *const ::std::os::raw::c_char,
    ...
    pub fn cass_error_result_keyspace(error_result: *const CassErrorResult,
        keyspace: *mut *const ::std::os::raw::c_char, keyspace_length: *mut size_t)
                                      -> CassError;
    ...
    pub fn cass_error_result_function(error_result: *const CassErrorResult,
        function: *mut *const ::std::os::raw::c_char, function_length: *mut size_t)
                                      -> CassError;
    ...
    pub fn cass_error_result_arg_type(error_result: *const CassErrorResult, index: size_t,
        arg_type: *mut *const ::std::os::raw::c_char, arg_type_length: *mut size_t)
                                      -> CassError;
    ...
    pub fn cass_iterator_get_meta_field_name(iterator: *const CassIterator, name: *mut *const ::std::os::raw::c_char,
        name_length: *mut size_t)
                                             -> CassError;
    ...
    pub fn cass_uuid_from_string_n(str: *const ::std::os::raw::c_char, str_length: size_t, output: *mut CassUuid)
                                   -> CassError;
    ...
    pub fn cass_inet_from_string_n(str: *const ::std::os::raw::c_char, str_length: size_t, output: *mut CassInet)
                                   -> CassError;
